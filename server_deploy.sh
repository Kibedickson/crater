...
docker-compose exec --tty app composer install --no-interaction --prefer-dist --optimize-autoloader --ignore-platform-reqs

# Migrate database
echo "docker-compose exec app php artisan migrate --force"
docker-compose exec --tty app php artisan migrate --force
